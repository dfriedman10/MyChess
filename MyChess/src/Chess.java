...
import javax.swing.JButton;
	...
	public class Chess extends JPanel implements MouseListener, Runnable {
		...
		public void computer_move() {
			GameTree t = new GameTree(board, turn, Integer.MIN_VALUE);
			int[] move = t.best_move_starter();
	...
	/**	public void computer_move() {
			...
			GameTree decision_tree = new GameTree(board, turn);
			int[] move = decision_tree.best_move();
		**/	
